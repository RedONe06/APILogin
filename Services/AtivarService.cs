...
{
    public class AtivarService
    {
        private EmailService _emailService;
        private UserManager<IdentityUser<int>> _userManager;

        public AtivarService(EmailService emailService, UserManager<IdentityUser<int>> userManager)
        {
            _emailService = emailService;
            _userManager = userManager;
        }

        public string EnviarEmailDeConfirmacao(IdentityUser<int> usuarioIdentity)
        {
